CHALLENGES = {
    ...
    5: {
        ...
        "finish": ["blue", "red", "green"],
        "goal": "Visit blue, then red, then reach green — maybe try writing a function for each leg",
    },
    6: {
        "cols": 8, "rows": 5,
        "start": (0, 0),
        "dots": {(4, 0): "orange", (4, 4): "blue", (7, 2): "red", (7, 4): "green"},
        "finish": ["orange", "blue", "red", "green"],
    ...
    8: {
        ...
        "finish": ["blue", "orange", "purple", "green"],
    ...
    9: {
        ...
        "finish": ["blue", "orange", "purple", "red", "green"],
    ...
    11: {
        ...
        "finish": ["blue", "orange", "blue", "orange", "blue", "orange", "green"],
